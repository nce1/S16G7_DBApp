...
<html>
    ...
    <body>
        <form action="processStatus.jsp" method="get">
            ...
            <select name="status" id="caseId">
            <option value="null"> <%= "Select" %> </option>
            <%  
                for (int i = 0; i < o.statusEntries.size(); i++) { 
            %>
                <option value="<%= o.statusEntries.get(i) %>"> <%= o.statusEntries.get(i) %> </option>
            <% 
                }
            %>
            </select>
