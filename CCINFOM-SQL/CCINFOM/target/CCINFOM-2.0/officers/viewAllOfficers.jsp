...
<body>
    ...
    <div class="container">
        ...
        %>
            <div class="profile-detail"><strong>Police ID:</strong> <span><%= O.policeIDList.get(i) %></span></div>
            <div class="profile-detail"><strong>Background ID:</strong> <span><%= O.backgroundIdList.get(i) %></span></div>
            <div class="profile-detail"><strong>Position:</strong> <span><%= O.positionIDList.get(i) %></span></div>
            <div class="profile-detail"><strong>Precinct ID:</strong> <span><%= O.precinctIDList.get(i) %></span></div>
            <div class="profile-detail"><strong>Start Date:</strong> <span><%= O.startDateList.get(i) %></span></div>
